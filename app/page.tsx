...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata("/", defaultSiteMetadata);
}
...
const poles = [
  {
    ...
    description:
      "Développement web, maintenance et support IT, community management et création d'identité visuelle.",
    href: "/technology"
  },
  {
    icon: "🛒",
  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 md:py-16">
        ...
        <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {poles.map((p) => (
            <article
              key={p.title}
              className="surface-card group bg-gradient-to-b from-white to-slate-50 p-5 transition duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-haitechBlue/20 md:p-6"
            >
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 md:py-16">
        <div className="surface-card p-8">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {[
              { label: "projets réalisés", end: 100, prefix: "+" },
              { label: "clients accompagnés", end: 50, prefix: "+" },
        ...
        <div className="surface-card p-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={point.title} className="surface-card bg-slate-50 p-5">
          ...
          <div className="mt-8 rounded-xl bg-haitechBlue p-6 text-white">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn-secondary mt-4 inline-block border-white text-white hover:bg-white hover:text-haitechBlue"
            >
              🟢 Parler sur WhatsApp
            </a>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 md:pb-20">
        <div className="surface-card bg-slate-50 p-8">
          ...
          <Link
            href="/contact"
            className="btn-primary mt-5 inline-block bg-haitechGold text-haitechBlue hover:bg-haitechGold/90"
          >
